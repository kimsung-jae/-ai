...
public class AutoDrawService extends Service{
    public static final String CHANNEL_ID="bubble_shape_ai_v21_live";
    ...
    private void createChannel(){
        if(Build.VERSION.SDK_INT>=26){
            NotificationChannel ch=new NotificationChannel(CHANNEL_ID,"Shape AI V2.1 자동추첨",NotificationManager.IMPORTANCE_LOW);
    ...
    private Notification buildNotification(){
        ...
        return b.setSmallIcon(android.R.drawable.ic_popup_sync)
                .setContentTitle("보글사다리 Shape AI V2.1 · 백그라운드 ON")
                .setContentText(text)
